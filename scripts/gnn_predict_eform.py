...
dataset = get_matminer_castelli_perovskites() 
...
# ax.set_title(r'Predict E$_{form}$ Benchmark')
fig.tight_layout() 
plt.savefig('fig-LossPlot_eform.svg')
# plt.close() 
...
ax.plot([0,6],[0,6],color='r',ls=':')
ax.grid(True,alpha=0.2)
ax.set_xlabel('True')
ax.set_ylabel('GNN Predicted')
ax.legend() 
fig.tight_layout() 
plt.savefig('fig-TvP_eform.svg')
